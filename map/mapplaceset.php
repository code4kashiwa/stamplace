...
<form name="frm" method="POST">
    ...
    <div id="detail_2nd" class="parts_details">
	  ...
	  <div id="infoset_params">
	      <input type="text" id="place_name" name="place_name" class="infoset_params_textbox" size="60" maxlength="40" />
	  ...
	  <div id="infoset_params">
	      <input type="text" id="address" name="address" class="infoset_params_textbox" size="60" maxlength="60" />
